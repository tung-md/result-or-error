...
public static partial class ResultOrErrorExtensions
{
    ...
    public static async Task<TNextValue> Match<TValue, TNextValue>(this Task<ResultOrError<TValue>> resultOrError, Func<TValue, TNextValue> onValue, Func<List<Error>, TNextValue> onError)
    {
    ...
    /// <param name="onError">The function to execute if the state is an error.</param>
    /// <returns>The result of the executed function.</returns>
    public static async Task<TNextValue> MatchAsync<TValue, TNextValue>(this Task<ResultOrError<TValue>> resultOrError, Func<TValue, Task<TNextValue>> onValue, Func<List<Error>, Task<TNextValue>> onError)
    {
        var result = await resultOrError.ConfigureAwait(false);
    ...
    /// <param name="onError">The function to execute if the state is an error.</param>
    /// <returns>The result of the executed function.</returns>
    public static async Task<TNextValue> MatchFirst<TValue, TNextValue>(this Task<ResultOrError<TValue>> resultOrError, Func<TValue, TNextValue> onValue, Func<Error, TNextValue> onError)
    {
        var result = await resultOrError.ConfigureAwait(false);
    ...
    /// <param name="onError">The function to execute if the state is an error.</param>
    /// <returns>The result of the executed function.</returns>
    public static async Task<TNextValue> MatchFirstAsync<TValue, TNextValue>(this Task<ResultOrError<TValue>> resultOrError, Func<TValue, Task<TNextValue>> onValue, Func<Error, Task<TNextValue>> onError)
    {
        var result = await resultOrError.ConfigureAwait(false);
